                        ...
                        <div class="date-sub-container">
                            <div class="date-container">
                                <div class="daterange-group">
                                    <label for="docDropdown" class="date-form-label">Sort Data</label>
                                ...
                                <form id="filterForm" method="GET" action="{{ route('export.csv') }}" class="date-form-wrapper">
                                    ...
                                    <div class="daterange-group">
                                        ...
                                        <button onclick="dvsearchByDateRange()" class="form-btn submit">Apply</button>
                ...
                <div class="input-dv-container">
                    ...
                    <div class="form-row-input">
                        <div class="form-column-input">
                            ...
                            <input type="text" name="folder" class="input-type-text">

                            <label>Account No.</label>
                            <input type="text" name="account_no" class="input-type-text">
                        </div>

                        <div class="form-column-input">
                            <label>RADAI/RCI Report No.</label>
                            <input type="text" name="radai" class="input-type-text">

                            <label>LDDAP-ADA / Check No.</label>
                            <input type="text" name="lddap" class="input-type-text">
...
function updateTableRows() {
    ...
    paginatedData.forEach(voucher => {
        ...
        row.innerHTML = `
            <td>${voucher.month_}</td>
            <td>${voucher.doc_}</td>
            <td>${formatCodeNo(voucher.code_no)}</td>
            <td>${voucher.folder}</td>
            <td>${voucher.account_no}</td>
            <td>${voucher.radai}</td>
            <td>${voucher.lddap}</td>
            <td>${voucher.total_amount.toLocaleString(undefined, { minimumFractionDigits: 2 })}</td>
            <td>${voucher.date_received}</td>
            <td>
